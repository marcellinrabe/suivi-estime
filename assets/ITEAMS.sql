...
--
-- Hôte : localhost
-- Généré le : mar. 16 nov. 2021 à 07:50
...
--
-- Déchargement des données de la table `distinctions`
--
...
INSERT INTO `estime` (`id`, `motif`, `point`, `id_membre`) VALUES
(1, NULL, 0, 19),
(2, NULL, 0, 21),
(3, ' dfsdf', 2, 2),
(4, NULL, 0, 28),
...
CREATE TABLE `formations` (
  ...
  `id_membre` int(11) NOT NULL,
  `ordre` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Cette table contient les formations de chaque membre';
...
--
-- Structure de la table `user_log_server`
--

CREATE TABLE `user_log_server` (
  `id` int(11) NOT NULL,
...
--
-- Déchargement des données de la table `user_log_server`
--
...
--
-- Index pour la table `categorie_competence`
--
ALTER TABLE `categorie_competence`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `competences`
  ...
  ADD KEY `FK_competences_membre` (`id_membre`),
  ADD KEY `FK_competences_categorie_competence` (`id_categorie`);

--
-- Index pour la table `distinctions`
--
ALTER TABLE `distinctions`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_distinction_membre` (`id_membre`);
...
ALTER TABLE `fonction`
  ADD PRIMARY KEY (`id`) USING BTREE,
  ADD KEY `FK_fonction_poste` (`id_poste`);
...
ALTER TABLE `membre`
  ADD PRIMARY KEY (`id`) USING BTREE,
  ADD UNIQUE KEY `prenom_usuel` (`prenom_usuel`);
...
--
-- Index pour la table `user_log_server`
--
ALTER TABLE `user_log_server`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT pour la table `categorie_competence`
--
ALTER TABLE `categorie_competence`
...
--
-- AUTO_INCREMENT pour la table `distinctions`
--
ALTER TABLE `distinctions`
...
--
-- AUTO_INCREMENT pour la table `user_log_server`
--
ALTER TABLE `user_log_server`
...
--
ALTER TABLE `competences`
  ADD CONSTRAINT `FK_competences_categorie_competence` FOREIGN KEY (`id_categorie`) REFERENCES `categorie_competence` (`id`),
  ADD CONSTRAINT `FK_competences_membre` FOREIGN KEY (`id_membre`) REFERENCES `membre` (`id`);

--
-- Contraintes pour la table `distinctions`
--
ALTER TABLE `distinctions`
  ADD CONSTRAINT `FK_distinction_membre` FOREIGN KEY (`id_membre`) REFERENCES `membre` (`id`);

--
-- Contraintes pour la table `experiences`
--
ALTER TABLE `experiences`
  ADD CONSTRAINT `FK_experiences_membre` FOREIGN KEY (`id_membre`) REFERENCES `membre` (`id`);

--
-- Contraintes pour la table `formations`
--
ALTER TABLE `formations`
  ADD CONSTRAINT `FK_formations_membre` FOREIGN KEY (`id_membre`) REFERENCES `membre` (`id`);
COMMIT;
